...
//        
    ...
    public String updataByUsername(Model model,@RequestParam Integer feeAmount,@RequestParam String feePaymentMethod,@RequestParam String feeOnlineOrOffline) throws Exception {
        if((Objects.equals(feeOnlineOrOffline, "Offline")&& Objects.equals(feePaymentMethod, "No need"))||(Objects.equals(feeOnlineOrOffline, "Online") && !Objects.equals(feePaymentMethod, "No need"))) {
            System.out.println("jnjnjnjnjnjnjnjnjnjnj");
            ...
            Context_payment offline_no_method = new Context_payment(new offline_no_method());
            String payment="";
//            payment=feePaymentMethod;
            System.out.println("feemethodindatabse:");
            System.out.println(studentfee_temp.getFeepaymentmethod());//0
            ...
            switch (studentfee_temp.getFeepaymentmethod()){
                ...
                case (0)->{
                    ...
                    payment=offline_no_method.executeStrategy_payment();
                }
            }

            System.out.println("::::::::::::::::::::::::::::::");
            System.out.println(payment);//Noneed
            ...
            if(studentfee_temp.getFeeonlineoroffline()!=3){
                if(Objects.equals(feeOnlineOrOffline, "Online") && studentfee_temp.getFeeonlineoroffline()==1 && Objects.equals(feePaymentMethod, payment)){
                ...
                else if(Objects.equals(feeOnlineOrOffline, "Offline") && studentfee_temp.getFeeonlineoroffline()==2 && Objects.equals(feePaymentMethod, payment)){
                    System.out.println("[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[[");
                    if((studentfee_temp.getFeeamount()-feeAmount)>=0){
                        String status=FeeService.UpdateByUserName(session,studentfee_temp.getFeepayerusername(),
                        ...
                        Feeforshow studentfee=new Feeforshow(studentfee_temp.getFeeid(),studentfee_temp.getFeeamount(),
                                studentfee_temp.getFeepayerusername(),status,str,feePaymentMethod);
                ...
                //TODO 费用削减失败时页面导航
                if((studentfee_temp.getFeeamount()-feeAmount)>=0){
//                    System.out.println("feePaymenMethodUpdate");
//                    System.out.println(feePaymentMethod);
                    String status=FeeService.UpdateByUserName(session,studentfee_temp.getFeepayerusername(),
                            studentfee_temp.getFeeamount()-feeAmount,feePaymentMethod,
                            studentfee_temp.getFeeonlineoroffline(),studentfee_temp.getFeestatus());
...
//
            ...
            return "student/Exception_payment";
        }
